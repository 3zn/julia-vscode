...
@everywhere Pkg.activate(joinpath(@__DIR__, "packages")) # Ensure vscode environment is activated
@everywhere using SymbolServer, LanguageServer # Load packages across workers
